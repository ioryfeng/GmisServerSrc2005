                ...
                For i = 0 To dsWorklog.Tables(0).Rows.Count - 1
                    ...
                    With newRow
                        ...
                        If tmpTaskStatus = "" Then
                            ...
                            ''添加工作日志
                            'AddWorkLog(projectID, finishedTaskID, tmpTaskName, userID, "F", startTime, Now, 1, tmpProjectPhase, tmpProjectStatus)

                        Else
                            .Item("project_status") = tmpTaskStatus

                            'AddWorkLog(projectID, finishedTaskID, tmpTaskName, userID, "F", startTime, Now, 1, tmpProjectPhase, tmpTaskStatus)
                        End If
